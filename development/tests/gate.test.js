...
test('the block reason opens with session-context triage before the dispatch orders', () => {
  ...
  assert.match(reason, /Genuinely unsure/)
  assert.match(reason, /ONE\s+AskUserQuestion/)
  assert.match(reason, /Audit \(recommended\)/)
  assert.match(reason, /unsure fails toward audit/)
